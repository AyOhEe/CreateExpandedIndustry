...
public class EIConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> ctx) {
        FeatureUtils.register(ctx, HARDENED_ERYTHRITE_PATCH, EIFeatures.HARDENED_STONE_PATCH.get(),
                new HardenedStonePatchConfiguration(EIBlocks.HARDENED_ERYTHRITE_BLOCK.get().defaultBlockState(), EIBlocks.ERYTHRITE_BLOCK.get().defaultBlockState()));
        FeatureUtils.register(ctx, HARDENED_OCHRUM_PATCH,    EIFeatures.HARDENED_STONE_PATCH.get(),
                new HardenedStonePatchConfiguration(EIBlocks.HARDENED_OCHRUM_BLOCK.get().defaultBlockState(), AllPaletteStoneTypes.OCHRUM.getBaseBlock().get().defaultBlockState()));
        FeatureUtils.register(ctx, HARDENED_CRIMSITE_PATCH,  EIFeatures.HARDENED_STONE_PATCH.get(),
                new HardenedStonePatchConfiguration(EIBlocks.HARDENED_CRIMSITE_BLOCK.get().defaultBlockState(), AllPaletteStoneTypes.CRIMSITE.getBaseBlock().get().defaultBlockState()));
        FeatureUtils.register(ctx, HARDENED_ASURINE_PATCH,   EIFeatures.HARDENED_STONE_PATCH.get(),
                new HardenedStonePatchConfiguration(EIBlocks.HARDENED_ASURINE_BLOCK.get().defaultBlockState(), AllPaletteStoneTypes.ASURINE.getBaseBlock().get().defaultBlockState()));
        FeatureUtils.register(ctx, HARDENED_VERIDIUM_PATCH,  EIFeatures.HARDENED_STONE_PATCH.get(),
                new HardenedStonePatchConfiguration(EIBlocks.HARDENED_VERIDIUM_BLOCK.get().defaultBlockState(), AllPaletteStoneTypes.VERIDIUM.getBaseBlock().get().defaultBlockState()));
    }
}
