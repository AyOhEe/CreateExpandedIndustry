...
public class ColumnCrackingCategory extends CreateRecipeCategory<ColumnCrackingRecipe> {
    public ColumnCrackingCategory(Info info) {
        super(info);
    }

    @Override
    protected void setRecipe(IRecipeLayoutBuilder builder, ColumnCrackingRecipe recipe, IFocusGroup focuses) {
    ...
    public Component getTitle() {
        return Component.translatable("createexpandedindustry.recipe.column_cracking");
    }

    @Override
    protected void draw(ColumnCrackingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gui, double mouseX, double mouseY) {
